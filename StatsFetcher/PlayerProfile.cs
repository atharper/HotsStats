...
namespace StatsFetcher
{
  public class PlayerProfile : INotifyPropertyChanged
  {
    ...
    public string Link => HotslogsId == null ? null : $"http://www.hotslogs.com/Player/Profile?PlayerID={HotslogsId}";

    // using this properties greatly simplifies style bingings in gui
    public bool IsMe => Game.Me == this;

    public bool IsMyTeam => Game.Me?.Team == Team;
